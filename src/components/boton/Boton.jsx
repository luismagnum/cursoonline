...
const Boton = () => {
  return (
    <div className='w-full ml-0 space-y-5 px-5 lg:px-0 mb-10 lg:mb-28 z-0'>
      <h1 className='text-left text-teal-500 font-bold text-xl md:text-2xl'></h1>
    <div className=' text-teal-500 w-1/3 text-sm md:text-2xl font-bold'>
    ...
    <a href="https://wa.me/543412143000?text=Hola quiero informacion" target="_blank">Informacion</a>
    </button>
    </div>
    </div>
  )
